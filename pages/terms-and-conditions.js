        ...
        <div>
          ...
          <div className="MsoNormal">
            <div className="MsoNormal" data-custom-className="body_text">
              ...
              &ldquo;Last updated&rdquo; date of these Terms of Use, and you
          ...
          <div className="MsoNormal">
            <div className="MsoNormal">
              <div className="MsoNormal" data-custom-className="body_text">
                ...
                and you agree to comply with these Terms of Use;(4) you are not
          ...
          <div className="MsoNormal">
                ...
                <div className="MsoNormal">
                  <div className="MsoNormal" data-custom-className="body_text">
                    <span data-custom-className="body_text">
                      ...
                      <br /> 2. You are the creator and owner of or have the
                      ...
                      <br /> 3. You have the written consent, release, and/or
            ...
            <div>
              ...
              <div className="MsoNormal" data-custom-className="body_text">
                ...
                is hosted in __________. If you access the Site from any other
                region of the world with laws or other requirements governing
                personal data collection, use, or disclosure that differ from
                applicable laws in __________, then through your continued use
                of the Site, you are transferring your data to __________, and
                you agree to have your data transferred to and processed in
                __________. Further, we do not knowingly accept, request, or
                solicit information from children or knowingly market to
                children. Therefore, in accordance with the U.S.
                Children&rsquo;s Online Privacy Protection Act, if we receive
            ...
            <div>
              ...
              <div data-custom-className="body_text">
                ...
                below (a &ldquo;Notification&rdquo;). A copy of your
              ...
              <div>
                ...
                <div className="MsoNormal" data-custom-className="body_text">
                  ...
                  expressly excluded. If your habitual residence is in the EU,
                  and you are a consumer, you additionally possess the
                  protection provided to you by obligatory provisions of the law
                  of your country of residence. THOMAS LTD and yourself both
                  agree to submit to the non-exclusive jurisdiction of the
                  courts of __________, which means that you may make a claim to
              ...
              <div>
                ...
                <div className="MsoNormal" data-custom-className="body_text">
                  ...
                  London, United Kingdom.&nbsp;The language of the proceedings
            ...
            <div>
              <div className="MsoNormal" data-custom-className="body_text">
                ...
                BY YOU TO US&nbsp;DURING THE six (6) mONTH PERIOD PRIOR TO ANY
            ...
            <div>
              <div className="MsoNormal" data-custom-className="body_text">
                ...
                the Site; (3) breach of these Terms of Use; (4) any breach of
          ...
          <div>
            ...
            <a href="https://termly.io/products/terms-and-conditions-generator/?ftseo">
              Termly&rsquo;s Terms and Conditions Generator
            </a>
            .
          </div>
        </div>
