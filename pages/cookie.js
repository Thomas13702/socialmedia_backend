      ...
      <div data-custom-class="body">
        ...
        <div>
          <span data-custom-class="body_text">
            ...
            technologies, please email us at thomaspritchard137@btinternet.com
            or by post to:
          </span>
        </div>
        <div>
          <span data-custom-class="body_text">THOMAS LTD</span>
        </div>
        <div>
          <span data-custom-class="body_text">5 Burdock Close</span>
        </div>
        <div>
          <span data-custom-class="body_text">Andover, Hampshire SP11 7RS</span>
        </div>
        <div>
          <span data-custom-class="body_text"> United Kingdom </span>
        </div>
        <div>
          <span data-custom-class="body_text"> Phone: 07934903945 </span>
        </div>
      </div>
      <div>
        This cookie policy was created using
        <a href="https://termly.io/en/products/cookie-consent-manager/?ftseo">
          Termly&rsquo;s Cookie Consent Manager
        </a>
        .
      </div>
    </div>
